        ...
        <div className="contact__details">
            ...
            <div className="contact__info">
                <div className="d-flex gap-3 align-items-center my-4">
                    <a href="/" className="border center rounded-circle text-dark" style={{width:'55px',height:'55px'}}>{<Telephone size={25}/>}</a>
                    <div><h4>Phone</h4><p className="m-0">(208) 000-0002</p></div>
                </div>
                <div className="d-flex gap-3 align-items-center my-4">
                    <a href="/" className="border center rounded-circle text-dark" style={{width:'55px',height:'55px'}}>{<Envelope size={25}/>}</a>
                    <div><h4>Email</h4><p className="m-0">hexfashion@furnito.com</p></div>
                </div>
                <div className="d-flex gap-3 align-items-center my-4">
                    <a href="/" className="border center rounded-circle text-dark" style={{width:'55px',height:'55px'}}>{<Geo size={25}/>}</a>
